    ...
    <table class="table">
        ...
        <c:forEach items="${employeeList}" var="employee">
            <tr>
                ...
                <td>
                    <a class="btn btn-success mb-2" href="/employee?action=update&id=${employee.getId()}" role="button">Edit</a>
                </td>
                <td>
                    <button onclick="onDelete(${employee.getId()})" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#delModal">
                        Delete
                    </button>
                </td>
            </tr>
